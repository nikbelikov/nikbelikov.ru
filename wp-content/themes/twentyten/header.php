...
<head>
	...
	<link rel="apple-touch-startup-image" href="<?php bloginfo( 'stylesheet_directory' ); ?>/startup-image.png" />
	<link rel="apple-touch-startup-image" href="<?php bloginfo( 'stylesheet_directory' ); ?>/startup-image-iphone5.png" media="screen and (device-width: 320px) and (device-height: 568px) and (-webkit-device-pixel-ratio: 2)" />
