...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8">
    <title>Страничка Беликова Николая</title>
    <meta content="width=device-width, user-scalable=no" name="viewport">
    <meta content="yes" name="apple-mobile-web-app-capable">
    <meta content="black" name="apple-mobile-web-app-status-bar-style">
    <meta content="nikbelikov" name="apple-mobile-web-app-title">
    <link href="startup-image.png" rel="apple-touch-startup-image">
    <link href="startup-image-iphone5.png" media="screen and (device-width: 320px) and (device-height: 568px) and (-webkit-device-pixel-ratio: 2)" rel="apple-touch-startup-image">
    <link href="favi.ico" rel="shortcut i" type="image/x-i">
    <link href="apple-touch-i-precomposed.png" rel="apple-touch-i-precomposed">
    <link href="http://fonts.googleapis.com/css?family=Exo+2:100&amp;subset=cyrillic,latin" rel="stylesheet">
    <link href="css/lib/font-awesome.min.css" rel="stylesheet">
    <link href="css/lib/foundation.min.css" rel="stylesheet">
  ...
  <body>
    ...
    <section id="skills" class="skills">
      <h1>Magic</h1>
      <div class="row">
        <div class="medium-3 columns"><i class="fa fa-html5"></i>
          <p>HTML5, Jade, Haml, Markdown</p>
        </div>
        <div class="medium-3 columns"><i class="fa fa-css3"></i>
          <p>Animation Transition LESS Sass Compass Autoprefixer</p>
        </div>
        <div class="medium-3 columns"><i class="fa fa-bolt"></i>
          <p>Javascript jQuery</p>
        </div>
        <div class="medium-3 columns"><i class="fa fa-github"></i>
          <p>Git (GitFlow) SVN Mercurial SourceTree</p>
        </div>
      </div>
      <div class="row">
        <div class="medium-3 columns"><i class="fa fa-mobile"></i>
          <p>Responsive Retina iOS Android</p>
        </div>
        <div class="medium-3 columns"><i class="fa fa-apple"></i>
          <p>Mavericks Sublime Emmet GruntJS MAMP Evernote</p>
        </div>
        <div class="medium-3 columns"><i class="fa fa-desktop"></i>
          <p>Win Ubuntu Mac VirtualBox IE.Modern</p>
        </div>
        <div class="medium-3 columns"><i class="fa fa-eye"></i>
          <p>PhotoshopCC PngExpress Cloudup</p>
        </div>
      </div>
    </section>
    ...
    <section id="twitter" class="twitter">
      <h1>Twitter</h1><a href="https://twitter.com/_nikbelikov" target="_blank"><i class="fa fa-twitter"></i><span>@_nikbelikov</span></a>
    </section>
